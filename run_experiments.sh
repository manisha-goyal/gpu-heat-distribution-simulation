...
echo "block_size,iterations,grid_dimension,average_cpu_time,average_gpu_time,speedup" > $output_file
...
# Loop over the specified block sizes, iterations, and dimensions
for BLOCK_SIZE in "${BLOCK_SIZES[@]}"; do
    for ITER in "${ITERATIONS[@]}"; do
        for DIM in "${DIMENSIONS[@]}"; do
            echo "Running for Block Size: $BLOCK_SIZE, Iterations: $ITER, Dimension: $DIM"
